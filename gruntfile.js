...
module.exports = function(grunt) {
	...
	var watchFiles = {
		...
		clientCSS: ['public/modules/**/*.css', 'public/less/app.css'],
		...
		less: {
          development: {
            options: {
	          ...
	          optimization: 2,
	          sourceMap: true,
	          sourceMapFilename: 'public/css/app.less.map',
	          sourceMapBasepath: '/'
            },
            files: {
	...
	grunt.task.registerTask('loadConfig', 'Task that loads the config into a grunt option.', function() {
		...
		grunt.log.write('applicationCSSFiles', config.assets.css);
	});
	...
	// Build task(s).
	grunt.registerTask('build', ['lint', 'loadConfig', 'ngmin', 'uglify', 'cssmin', 'less']);
